export const es: Record<string, string> = {
  ...
  "enquiry.field.offer": "TRABAJO",
  "enquiry.field.problem": "PROBLEMA",
  "enquiry.field.when": "CUÁNDO",
  "enquiry.field.budget": "PRESUPUESTO",
  "enquiry.note.label": "¿ALGO QUE LO ANTERIOR NO DIGA?",
  "enquiry.note.placeholder": "Opcional. Un enlace, una fecha, una restricción.",
