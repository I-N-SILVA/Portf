export const en: Record<string, string> = {
  ...
  "enquiry.field.offer": "JOB",
  "enquiry.field.problem": "PROBLEM",
  "enquiry.field.when": "WHEN",
  "enquiry.field.budget": "BUDGET",
  "enquiry.note.label": "ANYTHING THE ABOVE DOESN'T SAY?",
  "enquiry.note.placeholder": "Optional. A link, a deadline, a constraint.",
  "enquiry.email.label": "WHERE DO I REPLY?",
  "enquiry.email.placeholder": "you@company.com",
  "enquiry.submit": "SEND IT",
  "enquiry.sending": "SENDING…",
  "enquiry.sent.title": "GOT IT.",
  "enquiry.sent.body": "That's with me — I read every one myself. You'll hear back within one working day, from a person, with a real answer about whether I'm the right call.",
  "enquiry.alt": "Rather use your own mail?",
  "enquiry.error.invalid": "That address doesn't look right — check it and try again.",
  "enquiry.error.throttled": "That's a few from this address in the last hour. Mail me directly and I'll pick it up.",
  "enquiry.error.unavailable": "Something broke on my end. Mail me directly and I'll still get it.",
  "intake.q3": "AND THE BUDGET?",
  "intake.q3.a": "Under £3k — small and sharp",
  "intake.q3.b": "£3k – £8k",
  "intake.q3.c": "£8k and up",
  "intake.q3.d": "No idea — tell me what it should be",
  "offers.proof": "SHIPPED —",
  "offers.1.proof": "StockSnap: field stocktaking, live in days",
  "offers.2.proof": "Copy, build, analytics and the numbers after.",
  "offers.3.proof": "A content engine that runs without anyone opening it",
