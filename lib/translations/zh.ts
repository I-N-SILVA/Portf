export const zh: Record<string, string> = {
  ...
  "enquiry.field.offer": "项目",
  "enquiry.field.problem": "问题",
  "enquiry.field.when": "时间",
  "enquiry.field.budget": "预算",
  "enquiry.note.label": "还有上面没说到的吗？",
  "enquiry.note.placeholder": "可选。一个链接、一个截止日期、一个限制。",
  ...
  "intake.q3": "预算呢？",
  "intake.q3.a": "£3k 以下 —— 小而精准",
  "intake.q3.b": "£3k – £8k",
  "intake.q3.c": "£8k 以上",
  "intake.q3.d": "不清楚 —— 告诉我应该是多少",
  "offers.proof": "已交付 —",
  "offers.1.proof": "StockSnap：现场盘点，数天内上线",
  "offers.2.proof": "文案、构建、分析，以及之后的数据。",
  "offers.3.proof": "一个无人打开也照常运转的内容引擎",
  "intake.cta": "从这里开始 →",
  "intake.q2": "多久之内？",
  "intake.q2.a": "这个月",
  "intake.q2.b": "这个季度",
