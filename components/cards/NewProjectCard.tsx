    ...
    return (
        ...
        >
            <Link
                ...
                className="group relative block bg-card rounded-2xl border border-border overflow-hidden hover:shadow-[0_0_30px_rgba(var(--primary-rgb),0.1)] transition-all duration-500 hover:-translate-y-2"
            >
