...
export default function ShaftStatusStrip() {
  ...
  const heightStr = useTransform(
    extraLoad,
    (latest) => `${Math.min(100, baseLoad + latest)}%`,
  );
  ...
  return (
    <div
      data-shaft-chrome
      className="fixed left-6 top-0 bottom-0 w-px z-[100] hidden xl:flex flex-col items-center py-12 pointer-events-none"
    >
      {/* Connector line */}
      <div
