            ...
            <div className="relative z-30 -mt-24 mb-20 text-center">
                <div className="container mx-auto px-6">
                    <motion.div
                        ...
                        className="mb-8"
                    >
                        <span className="font-syne text-xs md:text-sm tracking-[0.4em] uppercase text-sky-text-primary flex items-center justify-center gap-4 before:h-px before:w-12 before:bg-sky-border/40 after:h-px after:w-12 after:bg-sky-border/40">                            Build, ship, live.
                        </span>
                    </motion.div>
