    ...
    return (
        <div className="fixed inset-0 pointer-events-none z-[5] overflow-hidden">
            ...
            <motion.div
                ...
                className="absolute top-0 w-[40%] h-[15vh] -translate-x-1/2 bg-gradient-to-b from-sky-primary/20 via-sky-primary/5 to-transparent blur-[120px] dark:from-sky-primary/10 dark:via-sky-primary/2 dark:to-transparent"
            />
            ...
            <motion.div
                ...
                className="absolute bottom-0 w-[40%] h-[15vh] translate-x-1/2 bg-gradient-to-t from-sky-primary/20 via-sky-primary/5 to-transparent blur-[120px] dark:from-sky-primary/10 dark:via-sky-primary/2 dark:to-transparent"
            />

            {/* Vertical Edge Glows (Subtle accents) */}
            <motion.div
                style={{ opacity: useTransform(scrollYProgress, [0.1, 0.5, 0.9], [0, 0.3, 0]) }}
