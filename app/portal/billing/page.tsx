...
export default async function BillingPage({
  ...
  const { subscription, invoices } = await getClientBilling();
  const now = Date.now();

  return (
    <main className="os-stage">
      <p className="os-eyebrow">portal · billing</p>
      ...
      <div className="os-tablewrap" style={{ padding: "18px", marginBottom: "36px" }}>
        {subscription ? (
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <a href="/billing/portal" className="os-btn" style={{ marginTop: "6px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
            ...
            <a href="/billing/portal" className="os-btn" style={{ alignSelf: "flex-start" }}>
              Manage payment method →
            </a>
          </div>
        )}
